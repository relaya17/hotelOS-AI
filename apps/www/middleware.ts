 ...
 *
 * Naming: hotel-os-ai-www-….vercel.app → hotel-os-ai-api-….vercel.app
 * Override: set HOTELOS_API_ORIGIN on the Vercel www project.
 */
export const config = {
...
function resolveApiOrigin(requestUrl: URL): string {
  ...
  const apiHost = requestUrl.hostname
    .replace(/-(admin|executive|guest|work|www|api)-/i, "-api-")
    .replace(

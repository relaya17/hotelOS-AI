...
export const PLATFORM_PILLARS: readonly PlatformPillar[] = [
  ...
  },
  {
    ...
    body: "Suggest → Approve → Act על כסף ותעריף. בלי קופסה שחורה. בלי «הסוכן סגר לבד». אתם מאשרים מה שרגיש — ואז המערכת מבצעת.",
...
export const PROFIT_LEVERS = [
  {
    id: "time",
    title: "שעות ההנהלה שלכם חוזרות להחלטות",
    body: "כשתדריך הבוקר שלכם יורד מציד מידע לתמונה אחת, תמדדו את השעות ב־scorecard מול Pilot $5,000 ו־Network $1,000 לחודש — מספרים שלכם, לא הבטחה גנרית.",
  },
  {
    id: "risk",
    title: "הדחוף שלכם לא נעלם בין מחלקות",
    body: "מרכז תקלות עם אחריות ברורה מקצר לכם זמן תגובה. פחות פיצוי, פחות חדר סגור, פחות ביקורת בלי בעלים.",
  },
  {
    id: "lift",
    title: "הכנסה נלווית — כשאתם בוחרים",
    body: "Upsell ומוניטין→משימה נכנסים רק אם סוגרים אותם בהיקף שלכם. אתם משלמים על מה שרץ — ורואים המרה במדידה.",
  },
] as const;
...
export const MODULAR_PATHS = [
  {
    id: "wedge",
    title: "יום 1: מתחילים במה שמוכיח ערך",
    body: "תדריך · תקלות · HITL. שלושה מסכים בדמו. ככה אתם רואים שליטה — לפני שמרחיבים לכל המחלקות.",
  },
  {
    id: "expand",
    title: "אחרי הוכחה: מרחיבים דומיין־דומיין",
    body: "משק בית, קבלה, תחזוקה, HR, Guest — לפי הקצב שלכם. אפשר Network על חלק מהמערכת, בלי לקנות הכול ביום הראשון.",
  },
  {
    id: "integrate",
    title: "מעל ה־PMS שלכם — לא במקומו",
    body: "ה־PMS נשאר מקור האמת להזמנות. HotelOS מוסיפה אותות, המלצות ואישורים. בלי writeback עיוור. בלי פרויקט החלפת ליבה.",
  },
] as const;

  ...
  return (
    <div className="panel">
      ...
      <style>{`
        ...
        .chip { display:flex; align-items:center; gap:.4rem; border:1px solid var(--color-line-strong); background:var(--color-paper-elevated); border-radius:999px; padding:.5rem .9rem; font:inherit; font-weight:600; cursor:pointer; }
        ...
        .status--task-done { color:var(--color-sea-deep); background:var(--color-sea-soft); }
        ...
        .select-field select, .select-field textarea { font:inherit; border:1px solid var(--color-line-strong); border-radius:var(--radius-sm); padding:.85rem .95rem; background:var(--color-paper-elevated); resize:vertical; }

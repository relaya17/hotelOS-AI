...
const DICTS: Record<LocaleCode, Dictionary> = {
  ...
  ru: {
    ...
    "nav.approvals": "Одобрения ИИ",
      ...
      "legal.accessibility": "Заявление о доступности",
  ...
  th: {
    ...
    "nav.approvals": "การอนุมัติ AI",
      ...
      "legal.dpa": "แบบ DPA",
      "legal.accessibility": "คำชี้แจงการเข้าถึง",
  ...
  tr: {
    ...
    "nav.approvals": "AI onayları",
      ...
      "legal.accessibility": "Erişilebilirlik beyanı",
  ...
  el: {
    ...
    "nav.approvals": "Εγκρίσεις AI",
      ...
      "legal.privacy": "Προστασία προσωπικών δεδομένων",
      "legal.cookies": "Cookies",
      ...
      "legal.accessibility": "Δήλωση προσβασιμότητας",
